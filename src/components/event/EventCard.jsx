...
function EventCard({ event }) {
    ...
    return (
        <div className="card bg-base-100 flex-grow-0 flex-shrink-0 basis-[calc(33%-1.25rem)] shadow-xl">
            <figure>
                <img
                    src={image}
                    alt={name}
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-end">
                    {user.level === 1 && <button className="btn btn-neutral" onClick={() => navigate(`/event-edit/${id}`)}>Edit</button>}
